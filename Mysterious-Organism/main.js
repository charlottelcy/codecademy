    ...
    compareDNA(pAequor) {
      ...
      console.log(
        `Specimen #${this.specimenNum} and specimen #${
          pAequor.specimenNum
        } have ${(count / dnaLength) * 100}% DNA in common`,
      )
    },
    willLikelySurvive() {
      let countOfC = 0
...
// Test function mutate
/*
  const pAequor = pAequorFactory(1, mockUpStrand());
  console.log(pAequor.dna); // before mutation
  pAequor.mutate();
  console.log(pAequor.dna); // after mutation, there will be one letter difference between the 2
*/

// Test function compareDNA
/*
  ...
  console.log(pAequor.willLikelySurvive()); // Prints true if DNA is made up of at least 60% 'C' or 'G' bases.
*/
...
// Test function survivablepAequor
// Create 30 instances of pAequor that can survive
/* console.log("Count: " + survivablepAequor.length); // should print 30 */
